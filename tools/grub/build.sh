...
echo "Linking..."
ld -n --gc-section -T arch/x86_64/src/boot/linker.ld -o tools/grub/boot/novusk tools/grub/grub_boot tools/grub/multiboot_header tools/grub/long_mode_init target/x86_64-novusk/release/libx86_64_kernel_lib.a
